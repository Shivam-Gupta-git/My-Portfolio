        ...
        <div className='w-full lg:w-[50%] h-full flex flex-col justify-around gap-2 sm:gap-3 md:gap-0 py-2 sm:py-0'>
          ...
          <div className='min-h-[50px] sm:min-h-[60px] w-full md:h-[70px] sm:w-[90%] relative flex ' ref={box1Ref}>
            <div className='w-full   bg-white/12 rounded-r-2xl sm:rounded-r-3xl software-container-box-shadow'>
              <h3 className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-medium software-container-text1 px-2 sm:px-3 md:px-0 pt-1 sm:pt-0'>JAVASCRIPT</h3>
          ...
          <div className='min-h-[50px] sm:min-h-[60px] md:h-[70px] w-full sm:w-[65%] relative flex' ref={box2Ref}>
            <div className='w-full bg-white/12 rounded-r-2xl sm:rounded-r-3xl software-container-box-shadow'>
              <h3 className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-medium px-2 sm:px-3 md:px-0 pt-1 sm:pt-0'>MongoDB</h3>
          ...
          <div className='min-h-[50px] sm:min-h-[60px] md:h-[70px] w-full relative flex' ref={box3Ref}>
            <div className='w-full  bg-white/12 rounded-r-2xl sm:rounded-r-3xl software-container-box-shadow'>
              <h3 className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-medium px-2 sm:px-3 md:px-0 pt-1 sm:pt-0'>Express.js</h3>
          ...
          <div className='min-h-[50px] sm:min-h-[60px] md:h-[70px] w-full sm:w-[75%] relative flex' ref={box4Ref}>
            <div className='w-full  bg-white/12 rounded-r-2xl sm:rounded-r-3xl software-container-box-shadow'>
              <h3 className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-medium px-2 sm:px-3 md:px-0 pt-1 sm:pt-0'>React</h3>
          ...
          <div className='min-h-[50px] sm:min-h-[60px] md:h-[70px] w-full sm:w-[85%] relative flex' ref={box5Ref}>
            <div className='w-full bg-white/12 rounded-r-2xl sm:rounded-r-3xl software-container-box-shadow'>
              <h3 className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-medium px-2 sm:px-3 md:px-0 pt-1 sm:pt-0'>Node.js</h3>
